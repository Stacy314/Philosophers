...
/*   Updated: 2024/12/01 19:27:55 by apechkov         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void *philosopher_lifecycle(void *arg)
{
    ...
    while (1)
    {
        // Перевіряємо, чи не завершена симуляція
...
void	start_simulation(t_simulation *sim)
{
	...
	pthread_create(&monitor_thread, NULL, death_monitor, sim); //leak //передає посилання на існуючий об'єкт, а не створює копію
	i = 0;
	while (i < sim->num_philosophers)
	{
